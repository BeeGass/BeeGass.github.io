...
[^1]: {% cite richard_rhodes_2018 %}

[^2]: {% cite "energy.gov_2021a" %}

[^3]: {% cite boyd_2009 %}

[^4]: {% cite becker_2019 %}

[^5]: {% cite solar_industry_research_data %}
...
[^9]: {% cite silicon_statistics_and_information %}

[^10]: {% cite wikipedia_2021a %}

[^11]: {% cite wikipedia_2021b %}

[^12]: {% cite wikipedia_2021c %}

[^13]: {% cite "energy.gov_2021b" %}

[^14]: {% cite nuclear_energy_institute %}
